...
<body id="bodyIndex" style="background-color: rgb(47, 179, 255);">
    ...
    <?php
                        ...
                        ?>
    <nav style="background-color: rgba(255,255,255,0.3);" class="navbar navbar-expand-lg navbar-light ">
        <!-- Container wrapper -->
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="nav-link d-block d-sm-none" href="ingresoVistaProfesional.php">Cambiar a vista de profesional</a>
            ...
            <div class="d-flex align-items-center">
                <a class="nav-link d-none d-sm-block" href="ingresoVistaProfesional.php">Cambiar a vista de profesional</a>
